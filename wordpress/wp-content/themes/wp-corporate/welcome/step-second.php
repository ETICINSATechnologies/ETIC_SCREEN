...
add_thickbox();
$wp_corporate_recommended_plugins = array(
	...
	<div class="feature-section recommended-plugins">
		<?php foreach ( $wp_corporate_recommended_plugins as $plugin => $prop ) { ?>
		<?php
		...
		switch ( $active['needs'] ) {
			...
			$label = __( 'Install', 'wp-corporate' );
			break;
			case 'activate':
			$class = 'activate-now button button-primary';
			$label = __( 'Activate', 'wp-corporate' );
			break;
			case 'deactivate':
			$class = 'deactivate-now button';
			$label = __( 'Deactivate', 'wp-corporate' );
			break;
		}
		...
		<div class="col plugin_box">
			<?php if ( $prop['recommended'] ): ?>
				<span class="recommended"><?php _e( 'Required', 'wp-corporate' ); ?></span>
			<?php endif; ?>
			...
			<div class="b-wrap">
			<span class="version"><?php echo __( 'Version:', 'wp-corporate' ); ?><?php echo esc_html( $info->version ) ?></span>
